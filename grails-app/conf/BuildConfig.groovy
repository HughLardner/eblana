...
grails.project.fork = [
    ...
    run: [maxMemory: 2048, minMemory: 768, debug: false, maxPerm: 2048, forkReserve:false],
    // configure settings for the run-war JVM
    war: [maxMemory: 2048, minMemory: 768, debug: false, maxPerm: 2048, forkReserve:false],
