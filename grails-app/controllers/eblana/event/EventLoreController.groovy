...
class EventLoreController {
    ...
    def save(EventLore eventLoreInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'eventLoreInstance.label', default: 'EventLore'), eventLoreInstance.id])
    ...
    def update(EventLore eventLoreInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.updated.message', args: [message(code: 'EventLore.label', default: 'EventLore'), eventLoreInstance.id])
                redirect eventLoreInstance
            }
    ...
    def delete(EventLore eventLoreInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.deleted.message', args: [message(code: 'EventLore.label', default: 'EventLore'), eventLoreInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'eventLoreInstance.label', default: 'EventLore'), params.id])
                redirect action: "index", method: "GET"
            }
