...
<td class="blended">${instance.blendedCrystals}</td>
<td class="air">${instance.airCrystals}</td>
<td class="earth">${instance.earthCrystals}</td>
<td class="fire">${instance.fireCrystals}</td>
<td class="water">${instance.waterCrystals}</td>
<td class="void">${instance.voidCrystals}</td>
