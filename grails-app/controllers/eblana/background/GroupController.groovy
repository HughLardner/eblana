...
class GroupController {
    ...
    def save(Group groupInstance) {
        ...
        request.withFormat {
            form {
                flash.message = message(code: 'default.created.message', args: [message(code: 'groupInstance.label', default: 'Group'), groupInstance.id])
    ...
    protected void notFound() {
        request.withFormat {
            form {
                flash.message = message(code: 'default.not.found.message', args: [message(code: 'groupInstance.label', default: 'Group'), params.id])
                redirect action: "index", method: "GET"
            }
