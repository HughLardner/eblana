<td>${instance.requiredSkillToCraft}</td>
...
<td>${instance.blendedCrystals}</td>
<td>${instance.airCrystals}</td>
<td>${instance.earthCrystals}</td>
<td>${instance.fireCrystals}</td>
<td>${instance.waterCrystals}</td>
<td>${instance.voidCrystals}</td>
